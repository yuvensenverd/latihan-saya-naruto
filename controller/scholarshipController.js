...
module.exports = {
      ...
      .then((results) => {
        ...
        scholarship
          ...
          .then((resultTotalScholarship) => {
            ...
            return res
              .status(200)
              .send({ message: "Success Get All Scholarship", results, total });
            // return res.status(200).send(result)
          })
          .catch((err) => {
  ...
  getScholarshipDetailByAdmin: (req, res) => {
    ...
    scholarship
      .findAll({
        subQuery: false,
        attributes: ["id", "judul", "studentId", "currentValue"],
