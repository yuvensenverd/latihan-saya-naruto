...
module.exports = {
  emailer(to, subject, html, replacements, attachments) {
    let email = "operational@kasihnusantara.com";
    let password = "Oper4t10n4l";
    // if (result) {
    //     email = result.defaultEmail;
    //     password = result.password;
    // }
    let transporter = nodemailer.createTransport({
      name: "mail.kasihnusantara.com",
      host: "mail.kasihnusantara.com",
      port: 465,
      // service: 'gmail',
      secure: true,
      auth: {
  ...
  transporter: nodemailer.createTransport({
    ...
    secure: true,
    auth: {
      user: "operational@kasihnusantara.com",
      pass: "Oper4t10n4l",
    },
    tls: {
      rejectUnauthorized: false,
