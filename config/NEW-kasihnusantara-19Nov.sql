...
CREATE TABLE `scholarships` (
  ...
  `description` varchar(255) DEFAULT NULL,
  `shareDescription` varchar(255) DEFAULT NULL,
  `scholarshipStart` datetime DEFAULT NULL,
  `scholarshipEnded` datetime DEFAULT NULL,
...
-- Dump completed on 2019-11-21  7:43:49
