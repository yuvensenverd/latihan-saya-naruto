...
CREATE TABLE `payments` (
  ...
  `paymentType` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `paymentSource` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `nominal` int(11) NOT NULL,
  `statusPayment` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  `order_id` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `komentar` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `isAnonim` int(11) NOT NULL DEFAULT '0',
  `noPembayaran` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `payouts` (
  ...
  `beneficiary_name` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `beneficiary_account` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `bank` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `reference_no` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `notes` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `beneficiary_email` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `created_by` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `projects` (
  ...
  `projectImage` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `shareDescription` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `userId` int(11) DEFAULT NULL,
...
CREATE TABLE `scholarships` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `judul` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `studentId` int(11) NOT NULL,
  `userId` int(11) NOT NULL,
  `biayaSekolah` int(11) NOT NULL,
  `totalPayout` int(11) NOT NULL,
  `currentValue` int(11) DEFAULT NULL,
  `isOngoing` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT '0',
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `studentrevisions` (
  ...
  `pendidikanTerakhir` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `gender` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `alamat` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `tanggalLahir` datetime NOT NULL,
  `studentImage` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `provinsi` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `isDeleted` int(11) NOT NULL DEFAULT '0',
  `userId` int(11) DEFAULT NULL,
  `story` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `shareDescription` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `nomorRekening` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `pemilikRekening` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `alamatSekolah` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `bank` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `cabangBank` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `teleponSekolah` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `namaSekolah` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `kartuSiswa` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `raportTerakhir` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `kartuKeluarga` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `jumlahSaudara` int(11) NOT NULL,
  `biayaSekolah` int(11) NOT NULL,
  `kelas` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `dataPenghasilan` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `students` (
  ...
  `isDeleted` int(11) NOT NULL DEFAULT '0',
  `userId` int(11) DEFAULT NULL,
  `story` text COLLATE utf8mb4_0900_ai_ci,
  `shareDescription` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `nomorRekening` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `pemilikRekening` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `alamatSekolah` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  `kelas` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `dataPenghasilan` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `dataStatus` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `statusNote` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `phoneNumber` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '-',
  `isGoogle` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `isFacebook` varchar(255) COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `userImage` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `lastLogin` datetime NOT NULL,
  `verified` int(11) NOT NULL DEFAULT '0',
  `role` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
